...
namespace Flames.Discord2
{
    ...
    {
        public override string name { get { return "Discord2"; } }
    ...
    public class DiscordApiClient : AsyncWorker<DiscordApiMessage>
    {
        ...
        void HandleMessageEvent(JsonObject data)
        {
            ...
            if (user.ID == botUserID && channel == "1164773079143157810") return;
            if (user.ID == botUserID && channel == "1165306166608404560") return;
    ...
    public class DiscordWebsocket : ClientWebSocket
    {
        ...
        {
            SentIdentify = false;
            if (readable) Logger.Log(LogType.SystemActivity, "Discord2 relay bot closing: " + reason);
            Close();
