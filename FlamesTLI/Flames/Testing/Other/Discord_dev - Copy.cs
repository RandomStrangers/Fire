...
namespace Flames.DiscordPlugin
{
	...
	public sealed class CmdSayDiscordPlugin : Command
    {
        ...
        public override CommandAlias[] Aliases { get { return new[] { new CommandAlias("sayd0"), 
    ...
    public sealed class CmdDiscordPluginBot : RelayBotCmd
    {
        public override string name
        {
            get
    ...
    public sealed class CmdDiscordPluginControllers : BotControllersCmd
    {
        public override string name
        {
            get
