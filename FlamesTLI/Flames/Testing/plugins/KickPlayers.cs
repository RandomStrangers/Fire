...
namespace Flames
{
    public class KickPlayers : Plugin
    {
    ...
    public class CmdDevOnly : Command
    {
        ...
        {
            p.Message("&T/DevOnly True &H- Makes the server available only to developers of {0}&H.", Server.SoftwareName);
    ...
    public class CmdNoFabric : Command
    {
        ...
        public override void Help(Player p)
        {
            ...
            p.Message("&T/NoFabric False &H- Allows clients containing \"Fabric\" to join.");
        }
    }
}