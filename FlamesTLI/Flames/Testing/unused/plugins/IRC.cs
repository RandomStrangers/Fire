...
namespace Flames.IRC
{
    ...
    public class IRCBot2 : RelayBot
    {
        public Connection conn;
        public string botNick;
        public IRCNickList2 nicks;
        public bool ready;
       ...
       public void Join(string channel)
        ...
        public static Regex ircTwoColorCode = new Regex("(\x03\\d{1,2}),\\d{1,2}");
    ...
    public class IRCPlugin2 : Plugin
    {
    ...
    public class CmdIRCBot2 : RelayBotCmd
    {
        ...
        public override RelayBot Bot { get { return IRCPlugin2.Bot; } }
    }

    public class CmdIrcControllers2 : BotControllersCmd
    {
