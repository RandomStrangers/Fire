...
{
    public class CmdTntWars : RoundsGameCmd
    {
        ...
        public void HandleScores(Player p)
        {
            ...
            {
                p.Message("Round is not in progress!"); 
                return;
            }
        ...
        public override void HandleSet(Player p, RoundsGame game_, string[] args)
        {
            ...
            if (prop.CaselessEq("spawn"))
            {
                ...
                {
                    p.Message("&WCannot set spawns in Free For All mode"); 
                    return;
                }
            ...
            else if (prop.CaselessEq("gamemode"))
            {
                if (value.CaselessEq("tdm"))
                {
                    ...
                    {
                        p.Message("&cGamemode is already Team Deathmatch"); 
                        return;
                    }
                }
                else if (value.CaselessEq("ffa"))
                {
                    ...
                    {
                        p.Message("&cGamemode is already Free For All"); 
                        return;
                    }
                }
                else
