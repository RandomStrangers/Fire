...
namespace Flames
{
    ...
    public static class Chat
    {
        ...
        public static bool FilterAll(Player pl, object arg)
        {
            return true;
        }
        ...
        public static bool DeprecatedFilter(Player pl, object arg)
        {
            return false;
        }
        public static bool FilterRank(Player pl, object arg)
        {
            return pl.Rank == (LevelPermission)arg;
        }
        public static bool FilterPerms(Player pl, object arg)
        {
            return ((ItemPerms)arg).UsableBy(pl);
        }
        public static bool FilterPM(Player pl, object arg)
        {
            return pl == arg;
        }
        ...
        {
            Message(ChatScope.All, msg, null, null);
        }
        public static void MessageGlobal(string msg)
        {
            Message(ChatScope.Global, msg, null, null);
        }
