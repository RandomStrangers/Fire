...
namespace Flames.Platform
{
    ...
    public abstract class IOperatingSystem
    {
        ...
        {
            PlatformID platform = Context.OSVersion.Platform;
    ...
    public class UnixOS : IOperatingSystem
    {
        ...
        public virtual void RestartInPlace()
        {
            ...
            //     at TerminalDriver.ReadLine () [0x00000]
            //     at Terminal.ReadLine () [0x00013]
            //     at Flames.TerminalLineInterface.TerminalLoop () [0x00002]
            ...
            Terminal.WriteLine("execvp {0} failed: {1}", exe, Marshal.GetLastWin32Error());

            // .. and fallback to mono if that doesn't work for some reason
            execvp("mono", new string[] { "mono", Server.RestartPath, null });
            Terminal.WriteLine("execvp mono failed: {0}", Marshal.GetLastWin32Error());
        }
    ...
    public class LinuxOS : UnixOS
    {
        ...
        {
            // /proc/self/cmdline returns the terminal line arguments
