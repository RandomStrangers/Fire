...
namespace Flames
{
    public class BetacraftV2HeartbeatPlugin : Plugin
    {
        public const string CONFIG_FOLDER = "plugins/bcv2";
        ...
        public HeartbeatConfig bcv2Config = new HeartbeatConfig();
