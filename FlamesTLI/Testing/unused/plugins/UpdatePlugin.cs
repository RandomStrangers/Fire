...
namespace Flames.UpdatesPlugin
{
    ...
    {
        public override string name { get { return "UpdaterPlugin"; } }
  ...
  Updater.UpdateTask = Server.Background.QueueRepeat(Updater.UpdaterTask, null, TimeSpan.FromSeconds(10));
    ...
    {
        [ConfigString("base-url", "Updater", "https://github.com/ClassiCube/MCGalaxy/blob/master/", true)]
        public static string BaseURL = "https://github.com/ClassiCube/MCGalaxy/blob/master/";
        [ConfigString("downloads-url", "Updater", "https://github.com/ClassiCube/MCGalaxy/raw/master/Uploads/", true)]
        public static string URL = "https://github.com/ClassiCube/MCGalaxy/raw/master/Uploads/";
        ...
        [ConfigString("version", "Updater", "1.9.5.1", false)]
        public static string Version = "1.9.5.1";
    }
    public class CmdUpdate2 : Command2
    {
