...
using MCGalaxy.Modules.Relay.Discord2;
...
namespace PluginRelayRoute
{
    public sealed class RelayRoutePlugin : Plugin
    {
        ...
        const string ROUTES_FILE = "text/ircrelayroutes.txt";
        ...
        RelayBot GetRouteBot(string service)
        {
            ...
            if (service.CaselessEq("Discord")) return MCGalaxy.Modules.Relay.Discord2.DiscordPlugin.Bot;
