//reference plugins/HummusRelay.dll
...
using Flames.Modules.Relay.Hummus;
using Flames.Tasks;
namespace PluginHummusRoute
{
	public class HummusRoutePlugin : Plugin
	{
		public override string Flames_Version { get { return Server.Version; } }
		public override string name { get { return "HummusRoute"; } }
		...
		public override void Load(bool startup) {
			OnChannelMessageEvent.Register(OnMessage, Priority.Critical);
		...
		public const string ROUTES_FILE = "text/relayroutes_hummus_irc.txt";
		public static string[] default_routes = new string[] {
			...
			"#",
			"# Some examples:",
			"# - Route from Discord channel 123456789 to Hummus channel 9876543210",
			"#    Discord 123456789 : Hummus 9876543210",
			"# - Route from Discord channel 123456789 to Discord channel 987654321",
			"#    Discord 123456789 : Discord 987654321",
			"# - Route from Hummus channel 9876543210 to Discord channel 123456789",
			"#    Hummus 9876543210 : Discord 123456789",
		};
		...
		public RelayBot GetRouteBot(string service) {
			...
			if (service.CaselessEq("Hummus")) return HummusPlugin.Bot;
