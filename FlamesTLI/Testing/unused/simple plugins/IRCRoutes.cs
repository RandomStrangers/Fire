...
using Flames.Relay;
using Flames.Relay.Discord0;
using Flames.Relay.IRC0;

namespace PluginRelayRoute
{
    public sealed class RelayRoutePlugin : Plugin_Simple
    {
        public override string Flames_Version { get { return Server.Version; } }
        public override string Name { get { return "IRCRoutes"; } }
        ...
        const string ROUTES_FILE = "text/ircrelayroutes0.txt";
        ...
        {
            if (service.CaselessContains("IRC")) return IRCPlugin.Bot;
            if (service.CaselessContains("Discord")) return DiscordPlugin.Bot;
