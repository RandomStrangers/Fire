...
namespace Flames.DiscordDev
{
    ...
    public class DiscordBot : RelayBot
    {
        ...
        public override void DoDisconnect(string reason)
        {
            ...
            {
                Logger.Log(LogType.Warning, "Error disconnecting Discord2 bot: {0}", ex);
            }
        }
        ...
        public void DoUpdateStatus(SchedulerTask task)
        {
            ...
            {
                Logger.Log(LogType.Warning, "Error updating Discord2 status: {0}", ex);
            }
        }
    ...
    public class DiscordWebsocket : ClientWebSocket
    {
        ...
        public override void Close()
        {
            ...
            {
                Logger.Log(LogType.Warning, "Error closing Discord socket: {0}", ex);
            }
        }
