...
namespace Flames.Relay.Discord0
{
    public sealed class DiscordConfig
    {
        ...
        [ConfigString("status-message", "Presence (Status)", "with {PLAYERS} players on {SERVER}")]
        public string StatusMessage = "with {PLAYERS} players on {SERVER}";
        ...
        public const string PROPS_PATH = "properties/discordbot0.properties";
    ...
    public override string name { get { return "Discord0"; } }
        ...
        public override void Load(bool startup)
        {
            ...
            Command.Register(new CmdDiscordBot0());
            Command.Register(new CmdDiscordControllers0());
            Bot.Config = Config;
            Bot.ReloadConfig();
            Bot.Connect();
        ...
        public override void Unload(bool shutdown)
        {
            ...
            Bot.Disconnect("Disconnecting Simple Discord bot");
            Command.Unregister(Command.Find("DiscordBot0"));
            Command.Unregister(Command.Find("DiscordControllers0"));
        }

        void OnConfigUpdated() { Bot.ReloadConfig(); }
    }

    public sealed class CmdDiscordBot0 : RelayBotCmd
    {
        public override string name { get { return "DiscordBot0"; } }
        protected override RelayBot Bot { get { return DiscordPlugin.Bot; } }
    }

    public sealed class CmdDiscordControllers0 : BotControllersCmd
    {
        public override string name { get { return "DiscordControllers0"; } }
        protected override RelayBot Bot { get { return DiscordPlugin.Bot; } }
    }
    ...
    public sealed class DiscordWebsocket : ClientWebSocket
    {
        ...
        JsonObject MakePresence()
        {
            ...
            return new JsonObject()
            {
                { "since",      Server.StartTime.ToString() + 1 },
    ...
    public sealed class DiscordBot : RelayBot
    {
        ...
        public override string RelayName { get { return "Discord0"; } }
        ...
        TextFile replacementsFile = new TextFile("text/discord/replacements0.txt",
        ...
        {
            Controllers = PlayerList.Load("text/discord/controllers0.txt");
        }
