...
namespace Flames.IRC
{
    ...
    public sealed class IRCBot2 : RelayBot
    {
    ...
    public sealed class CmdIRCBot2 : RelayBotCmd
    {
        ...
        protected override RelayBot Bot { get { return IRCPlugin2.Bot; } }
    }

    public sealed class CmdIrcControllers2 : BotControllersCmd
    {
