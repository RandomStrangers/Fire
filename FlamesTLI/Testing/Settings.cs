...
namespace Flames
{
    public class ServerSettingsPlugin : Plugin
    {
        ...
        public Command css = new CmdChangeServerSetting();
        public Command vss = new CmdViewServerSettings();
        public override void Load(bool auto)
        {
            Command.Register(css, vss);
        }
        public override void Unload(bool auto)
        {
            Command.Unregister(css, vss);
        }
    ...
    public class CmdChangeServerSetting : Command
    {
