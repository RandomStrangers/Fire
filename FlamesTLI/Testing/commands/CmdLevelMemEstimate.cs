...
{
    public class CmdLevelMemEstimate : Command
    {
        ...
        public static long EstimateCustomBlocks(Level lvl)
        {
        ...
        public static long EstimatePhysics(Level lvl)
        {
            return
        ...
        public static int GetCount(Level lvl, string name)
        {
        ...
        public static string Simplify(long bytes)
        {
