...
{
    public RGBCol(byte R, byte G, byte B)
    {
        r = R;
        g = G;
        b = B;
...
namespace Flames
{
    public class Classic64 : Plugin
    {
        public override string name { get { return "Classic64Plugin"; } }
        ...
        public static void sendColorsToEveryone(Player p)
        {
        ...
        public static void sendCapToEveryone(Player p)
        {
            byte[] data = new byte[64];
        ...
        public static void receiveColorsFromEveryone(Player p)
        {
        ...
        public static void receiveCapsFromEveryone(Player p)
        {
            if (!marioSettings[p.name].hasPlugin) return;
        ...
        public unsafe static void readTickData(Player p, byte[] data)
        {
        ...
        public static void marioTick(SchedulerTask task)
        {
        ...
        public static void OnSentMap(Player p, Level prevLevel, Level level)
        {
            if (prevLevel == level)
            {
