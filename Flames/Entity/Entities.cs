...
namespace Flames
{
    ...
    public static class Entities
    {
        ...
        public static void Spawn(Player dst, Player p) 
        { 
            Spawn(dst, p, p.Pos, p.Rot); 
        }
        ...
        public static void SpawnEntities(Player p, bool bots = true) 
        { 
            SpawnEntities(p, p.Pos, p.Rot, bots); 
        }
        ...
        public static void UpdateModel(Entity e, string model) 
        { 
            e.UpdateModel(model); 
        }
