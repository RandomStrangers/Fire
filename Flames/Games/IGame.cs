...
namespace Flames.Games
{
    public abstract class IGame
    {
        ...
        public virtual bool HandlesBlockchange(Player p, ushort x, ushort y, ushort z)
        { 
            return false; 
        }
        ...
        public virtual bool ClaimsMap(string map) 
        { 
            return false; 
        }
        ...
        public void UpdateAllStatus1() 
        { 
            UpdateAllStatus(CpeMessageType.Status1); 
        }
        /// <summary> Sends CPE Status2 messages to all players in this game's current level </summary>
        public void UpdateAllStatus2() 
        { 
            UpdateAllStatus(CpeMessageType.Status2); 
        }
        /// <summary> Sends CPE Status3 messages to all players in this game's current level </summary>
        public void UpdateAllStatus3() 
        { 
            UpdateAllStatus(CpeMessageType.Status3); 
        }
        ...
        public virtual string FormatStatus1(Player p) 
        { 
            return ""; 
        }
        public virtual string FormatStatus2(Player p) 
        { 
            return ""; 
        }
        public virtual string FormatStatus3(Player p) 
        {
            return ""; 
        }
