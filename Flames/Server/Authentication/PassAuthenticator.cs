...
namespace Flames.Authentication
{
    ...
    public abstract class ExtraAuthenticator
    {
        ...
        public static ExtraAuthenticator Current { get; set; }
    ...
    public abstract class PassAuthenticator : ExtraAuthenticator
    {
        ...
        public void OnPlayerHelp(Player p, string target, ref bool cancel)
        {
        ...
        public void OnPlayerCommand(Player p, string cmd, string args, CommandData data)
        {
        ...
        public void ExecPassCommand(Player p, string message, CommandData data)
        {
        ...
        public void DoVerifyPassword(Player p, string password)
        {
            if (!p.Unverified) 
            { 
        ...
        public void DoSetPassword(Player p, string password)
        {
        ...
        public void DoResetPassword(Player p, string name, CommandData data)
        {
