...
namespace Flames.Generator
{
    ...
    public struct MapGenBiome
    {
        ...
        public static MapGenBiome Get(MapGenBiomeName theme)
        {
            switch (theme)
            {
                case MapGenBiomeName.Arctic: 
                    return Arctic;
                case MapGenBiomeName.Desert: 
                    return Desert;
                case MapGenBiomeName.Hell: 
                    return Hell;
                case MapGenBiomeName.Swamp: 
                    return Swamp;
                case MapGenBiomeName.Mine: 
                    return Mine;
                case MapGenBiomeName.Sandy:
                    return Sandy;
                case MapGenBiomeName.Plains: 
                    return Plains;
                case MapGenBiomeName.Space: 
                    return Space;
            }
            return Forest;
        }
