...
namespace Flames.Modules.Games.TW
{
    public partial class TWGame : RoundsGame
    {
        ...
        public bool CheckTNTPlace(Player p, TWData data, ushort x, ushort y, ushort z)
        {
            ...
            {
                p.Message("TNT cannot be placed in this area"); 
                return false;
            }
            ...
            {
                p.Message("TNT Wars: Maximum amount of TNT placed"); 
                return false;
            }
            if (data.TNTCounter > cfg.MaxActiveTnt)
            {
                p.Message("TNT Wars: You are past the maximum amount of TNT that can be placed!"); 
                return false;
            }
            return true;
        }
